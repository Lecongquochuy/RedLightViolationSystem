...
class ObjectTracking:
    def __init__(self):
        self.className = ["car", "green_light", "motobike", "red_light", "stop_line", "yellow_light"]
        self.colors = [(255, 0, 0), (0, 255, 0), (0, 100, 255), (0, 0, 255), (100, 100, 100), (255, 255, 0)]
        # self.className = ['bicycle', 'bus', 'car', 'green_light', 'motobike', 'red_light', 'stop_line', 'truck', 'yellow_light']
